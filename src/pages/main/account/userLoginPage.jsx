...
export default function UserLoginPage() {
  ...
  return (
    <StyledBoxDiv>
      ...
      <SocialLoginButton color="#fee500" width="100%"><RiKakaoTalkFill /> <span>&nbsp; &nbsp; 카카오로 로그인</span></SocialLoginButton>
      <SocialLoginButton color="#21c603" width="100%"><SiNaver /> <span>&nbsp; &nbsp; 네이버로 로그인</span></SocialLoginButton>
